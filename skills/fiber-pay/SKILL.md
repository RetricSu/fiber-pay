...
- **Rebalance operation**: Read [references/rebalance.md](references/rebalance.md) for high-level `channel rebalance` workflow and how it maps to payment primitives.
